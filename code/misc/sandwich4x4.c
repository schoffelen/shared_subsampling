    ...
    for (i=0; i<numelin/16; i++)
    {
      ...
      for (indx2=0; indx2<4; ++indx2)
        for (indx1=0; indx1<4; ++indx1)
          {
           a[indx1][indx2] = input1r[i*16+indx1+indx2*4];
           b[indx1][indx2] = input2r[i*16+indx1+indx2*4];
           
           c[indx1][indx2] = 0;
           output1r[i*16+indx1+indx2*4] = 0;
          }
      
      for (indx3=0; indx3<4; ++indx3)
        for (indx2=0; indx2<4; ++indx2)
          for (indx1=0; indx1<4; ++indx1)
            {
      ...
      for (indx3=0; indx3<4; ++indx3)
        for (indx2=0; indx2<4; ++indx2)
          for (indx1=0; indx1<4; ++indx1)
            {
             output1r[i*16+indx2+indx3*4] += c[indx2][indx1] * a[indx3][indx1];
            }
    }
    return;
  }
        ...
        for (indx1=0; indx1<4; ++indx1)
          {
           a[indx1][indx2]  = input1r[i*16+indx1+indx2*4];
           b[indx1][indx2]  = input2r[i*16+indx1+indx2*4];
           bi[indx1][indx2] = input2i[i*16+indx1+indx2*4];
          
           c[indx1][indx2] = 0;
           ci[indx1][indx2] = 0;
           output1r[i*16+indx1+indx2*4] = 0;
           output1i[i*16+indx1+indx2*4] = 0;
          }
      ...
      for (indx3=0; indx3<4; ++indx3)
        for (indx2=0; indx2<4; ++indx2)
          for (indx1=0; indx1<4; ++indx1)
            {
             output1r[i*16+indx2+indx3*4] += c[indx2][indx1] * a[indx3][indx1];
             output1i[i*16+indx2+indx3*4] += ci[indx2][indx1] * a[indx3][indx1];
            }
    }
    return;  
    ...
    for (i=0; i<numelin/16; i++)
    {
        ...
        for (indx1=0; indx1<4; ++indx1)
          {
           a[indx1][indx2]  = input1r[i*16+indx1+indx2*4];
           b[indx1][indx2]  = input2r[i*16+indx1+indx2*4];
           ai[indx1][indx2] = input1i[i*16+indx1+indx2*4];
      ...
      for (indx3=0; indx3<4; ++indx3)
        for (indx2=0; indx2<4; ++indx2)
          for (indx1=0; indx1<4; ++indx1)
            {
             output1r[i*16+indx2+indx3*4] += c[indx2][indx1] * a[indx3][indx1] + ci[indx2][indx1] * ai[indx3][indx1];
             output1i[i*16+indx2+indx3*4] += ci[indx2][indx1] * a[indx3][indx1] - c[indx2][indx1] * ai[indx3][indx1];
            }
    }
    return;  
  }  
